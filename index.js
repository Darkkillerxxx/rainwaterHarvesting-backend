...
app.get('/getAllLocationForDistricts',async(req,res)=>{
    try{
        ...
        const response = await queryData(`SELECT Latitude,longitude,Village,Location,Inauguration_DATE from Water_Harvesting WHERE DISTRICT='${DISTRICT}' AND Latitude IS NOT NULL AND Longitude IS NOT NULL`);
